...
void setup()
{
  ...
  size(400,400);
  PImage img;
  img = loadImage("/Users/CadenceDaniels/Downloads/FinalProject/snakeFinalProject/fireplace.jpg");
  image(img, 0, 0);
  textAlign(CENTER);
  
  file = new SoundFile(this, "/Users/CadenceDaniels/Downloads/FinalProject/snakeFinalProject/santa_baby.mp3");
  file.play();
...
void draw()
{
  ...
  PImage candycane;
  candycane = loadImage("/Users/CadenceDaniels/Downloads/FinalProject/snakeFinalProject/candy.jpg");


  PImage candycane_vert, candycane_hori;
  candycane_vert = loadImage ("/Users/CadenceDaniels/Downloads/FinalProject/snakeFinalProject/vertical.jpg");
  candycane_hori = loadImage ("/Users/CadenceDaniels/Downloads/FinalProject/snakeFinalProject/horizontal.jpg");
